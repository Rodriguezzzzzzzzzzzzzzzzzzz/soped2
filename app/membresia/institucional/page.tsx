        ...
        <div className="mi-inner">
          <div className="mi-header">
            ...
            <div className="mi-header-content">
              ...
              <h1 className="mi-title">Inscribe a tu <em>Institución</em></h1>
              <p className="mi-desc">
                Representa a tu institución en el ecosistema académico más
                prestigioso del debate peruano. Completa el formulario y nuestro
                equipo te guiará en el proceso de afiliación institucional.
              </p>
            </div>
          </div>
